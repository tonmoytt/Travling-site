...
const Room2 = () => {
    return (
       <div>
  <div className="pt-20 md:pt-32 border-t-2 border-b-2  px-4 sm:px-6 md:px-10">
    <div className="flex flex-wrap gap-x-6 gap-y-2">
      ...
      <Link to="/Hotel WBF Hommachi">
        <h1 className="font-semibold hover:underline cursor-pointer">Hotel WBF Hommachi</h1>
      </Link>
  ...
  {/* section 2 */}
  <div className="grid grid-cols-1 md:grid-cols-3 gap-2 pt-8 pb-5 bg-slate-50 px-4 sm:px-6 md:px-10">
    <div>
      <img className="w-full h-[150px] md:h-full rounded-lg object-cover" src={img1} alt="" />
    </div>

    <div className="flex flex-col gap-2">
      <img className="w-full h-auto rounded-lg object-cover" src={img2} alt="" />
      <img className="w-full h-auto rounded-lg object-cover" src={img3} alt="" />
    </div>

    <div className="flex flex-col gap-2">
      <img className="w-full h-auto rounded-lg object-cover" src={img4} alt="" />
      <img className="w-full h-auto rounded-lg object-cover" src={img5} alt="" />
    </div>
  </div>

  {/* section 3 */}
  <div className="px-4 sm:px-6 md:px-10 pt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
    <div className="col-span-1 md:col-span-2">
      ...
      <div className="flex flex-col md:flex-row justify-between border-b-2 pb-10 items-start md:items-center">
        ...
        <div className="flex gap-5 mt-6 md:mt-0">
          ...
          <div id="dropdown" className="border-2 rounded-full p-3 flex items-center gap-2 cursor-pointer hover:bg-red-100 transition">
            ...
            <img id="rounded" className="h-8 w-8 hover:bg-red-300 hover:rounded-full transition" src={love} alt="" />
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="pb-10 border-b-2 space-y-4 max-w-prose">
          <p>
            Studio Allston Hotel is the ideal point of departure for your excursions in Boston (MA). Conveniently located on the Charles River near Harvard University, the property offers spacious accommodation, contemporary technology and ample facilities for an excellent visit to historic Boston.
          </p>
          <p>
            Top features of the property include complimentary parking on-site, full service restaurant serving breakfast, lunch and dinner and free wireless internet access. Enjoy nearby jogging and bicycle paths, while children will like the play area across the street.
          </p>
          <p>
            All rooms exude an atmosphere of total peace and harmony that feature thoughtful amenities to ensure an unparalleled sense of comfort for the guests such as air conditioning, heating, satellite/cable channels, ironing facilities and toiletries. Studio Allston Hotel is an ideal place of stay for travelers seeking charm, comfort and convenience in Boston (MA).
          </p>
        </div>
      </div>
      ...
      <div className="pl-6 mt-6 pb-6 border-b-2 max-w-md">
        ...
        <div className="flex justify-between pb-6 max-w-xs">
          <div>Check in</div>
          <div>12.00pm</div>
        </div>
      ...
      <div className="flex flex-col sm:flex-row flex-wrap gap-6 justify-center md:justify-start">
        ...
        <div className="card card-compact w-full sm:w-96 bg-base-100 shadow-xl">
          <figure>
            <img src={postimg1} alt="Shoes" className="w-full h-auto object-cover rounded-t-lg" />
          </figure>
        ...
        <div className="card card-compact w-full sm:w-96 bg-base-100 shadow-xl">
          <figure>
            <img src={postimg2} alt="Shoes" className="w-full h-auto object-cover rounded-t-lg" />
          </figure>
          <div className="card-body">
            <Link to="/room1">
    ...
    {/* flex part 2 */}
    <div className="mx-4 mt-10 md:mt-0 max-w-md md:max-w-full md:mx-0">
      <div className="border-2 rounded-2xl py-6 px-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between pb-4 border-b-2 gap-4 sm:gap-0">
            <div className="flex-1">
              ...
              <input
                ...
                name=""
                id=""
                className="w-full sm:w-auto rounded-md border border-gray-300 p-2"
              />
            </div>
        ...
        <div className="px-4 mt-10">
          <button className="btn rounded-3xl hover:bg-rose-500 bg-blue-500 w-full font-semibold text-white">
            Reserve
          </button>
        </div>
      </div>
