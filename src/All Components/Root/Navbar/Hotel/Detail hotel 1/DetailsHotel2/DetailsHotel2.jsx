  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 pt-8 pb-5 bg-slate-50 px-4 md:px-10">
        <div>
          <img
            className="w-full h-[150px] md:h-[810px] rounded-lg object-cover"
            src={img1}
            alt="hotel pic 1"
          />
        </div>
        ...
        <div className="grid grid-rows-2 gap-2">
          <img
            className="rounded-lg w-full h-[150px] md:h-full object-cover"
            src={img2}
            alt="hotel pic 2"
          />
          <img
        ...
        <div className="col-span-2">
          ...
          <div className="flex flex-col md:flex-row justify-between border-b-2 pb-10 items-start md:items-center">
            <div>
              ...
              <div className="flex flex-wrap items-center gap-3 mt-4">
                <p className="border border-success bg-gray-100 text-center py-1 text-blue-500 font-bold w-16 rounded-lg">
                  5 / 5
                </p>
                <p className="font-bold font-mono">Excellent</p>
                <p className="text-blue-500">(7 review)</p>
                <p className="text-gray-500">Virginia</p>
              </div>
            </div>
            <div className="flex gap-5 mt-5 md:mt-0">
              ...
              <div
                id="dropdown"
                className="border-2 rounded-full p-1 cursor-pointer hover:bg-red-300 transition flex items-center space-x-2"
              >
                <p
                  id="submenu2"
                  className="text-sm text-red-500 border-2 rounded px-2"
                >
                  Add to wishlist
                </p>
          ...
          <div>
            ...
            <div className="pb-10 border-b-2 space-y-4">
              <p>
                Studio Allston Hotel is the ideal point of departure for your
                excursions in Boston (MA). Conveniently located on the Charles
                River near Harvard University, the property offers spacious
                accommodation, contemporary technology and ample facilities for
                an excellent visit to historic Boston.
              </p>

              <p>
                Top features of the property include complimentary parking
                on-site, full service restaurant serving breakfast, lunch and
                dinner and free wireless internet access. Enjoy nearby jogging
                and bicycle paths, while children will like the play area across
                the street.
              </p>

              <p>
                All rooms exude an atmosphere of total peace and harmony that
                feature thoughtful amenities to ensure an unparalleled sense of
                comfort for the guests such as air conditioning, heating,
                satellite/cable channels, ironing facilities and toiletries.
                Studio Allston Hotel is an ideal place of stay for travelers
                seeking charm, comfort and convenience in Boston (MA).
              </p>
            </div>
          </div>
